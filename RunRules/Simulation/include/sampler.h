...
#define sampler_MersenneTwister_seedOffset (8256754)
#define sampler_map_number (5)
#define sampler_N (128)
#define sampler_MersenneTwister_n (624)
#define sampler_PCIE_ALIGNMENT (16)
#define sampler_samplerKernelseed1_mt (4)
#define sampler_samplerKernelseed2_mt (4)
 ...
 * \param [in] inmem_samplerKernel_samplerKernelseed1_mt_seeds0 Mapped ROM inmem_samplerKernel_samplerKernelseed1_mt_seeds0, should be of size (624 * sizeof(uint64_t)).
 * \param [in] inmem_samplerKernel_samplerKernelseed1_mt_seeds1 Mapped ROM inmem_samplerKernel_samplerKernelseed1_mt_seeds1, should be of size (624 * sizeof(uint64_t)).
 * \param [in] inmem_samplerKernel_samplerKernelseed1_mt_seeds2 Mapped ROM inmem_samplerKernel_samplerKernelseed1_mt_seeds2, should be of size (624 * sizeof(uint64_t)).
 * \param [in] inmem_samplerKernel_samplerKernelseed1_mt_seeds3 Mapped ROM inmem_samplerKernel_samplerKernelseed1_mt_seeds3, should be of size (624 * sizeof(uint64_t)).
 * \param [in] inmem_samplerKernel_samplerKernelseed2_mt_seeds0 Mapped ROM inmem_samplerKernel_samplerKernelseed2_mt_seeds0, should be of size (624 * sizeof(uint64_t)).
 * \param [in] inmem_samplerKernel_samplerKernelseed2_mt_seeds1 Mapped ROM inmem_samplerKernel_samplerKernelseed2_mt_seeds1, should be of size (624 * sizeof(uint64_t)).
 * \param [in] inmem_samplerKernel_samplerKernelseed2_mt_seeds2 Mapped ROM inmem_samplerKernel_samplerKernelseed2_mt_seeds2, should be of size (624 * sizeof(uint64_t)).
 * \param [in] inmem_samplerKernel_samplerKernelseed2_mt_seeds3 Mapped ROM inmem_samplerKernel_samplerKernelseed2_mt_seeds3, should be of size (624 * sizeof(uint64_t)).
 */
void sampler(
	...
	const uint64_t *inmem_samplerKernel_samplerKernelseed1_mt_seeds0,
	const uint64_t *inmem_samplerKernel_samplerKernelseed1_mt_seeds1,
	const uint64_t *inmem_samplerKernel_samplerKernelseed1_mt_seeds2,
	const uint64_t *inmem_samplerKernel_samplerKernelseed1_mt_seeds3,
	const uint64_t *inmem_samplerKernel_samplerKernelseed2_mt_seeds0,
	const uint64_t *inmem_samplerKernel_samplerKernelseed2_mt_seeds1,
	const uint64_t *inmem_samplerKernel_samplerKernelseed2_mt_seeds2,
	const uint64_t *inmem_samplerKernel_samplerKernelseed2_mt_seeds3);
...
typedef struct { 
	...
	const uint64_t *inmem_samplerKernel_samplerKernelseed1_mt_seeds0; /**<  [in] Mapped ROM inmem_samplerKernel_samplerKernelseed1_mt_seeds0, should be of size (624 * sizeof(uint64_t)). */
	const uint64_t *inmem_samplerKernel_samplerKernelseed1_mt_seeds1; /**<  [in] Mapped ROM inmem_samplerKernel_samplerKernelseed1_mt_seeds1, should be of size (624 * sizeof(uint64_t)). */
	const uint64_t *inmem_samplerKernel_samplerKernelseed1_mt_seeds2; /**<  [in] Mapped ROM inmem_samplerKernel_samplerKernelseed1_mt_seeds2, should be of size (624 * sizeof(uint64_t)). */
	const uint64_t *inmem_samplerKernel_samplerKernelseed1_mt_seeds3; /**<  [in] Mapped ROM inmem_samplerKernel_samplerKernelseed1_mt_seeds3, should be of size (624 * sizeof(uint64_t)). */
	const uint64_t *inmem_samplerKernel_samplerKernelseed2_mt_seeds0; /**<  [in] Mapped ROM inmem_samplerKernel_samplerKernelseed2_mt_seeds0, should be of size (624 * sizeof(uint64_t)). */
	const uint64_t *inmem_samplerKernel_samplerKernelseed2_mt_seeds1; /**<  [in] Mapped ROM inmem_samplerKernel_samplerKernelseed2_mt_seeds1, should be of size (624 * sizeof(uint64_t)). */
	const uint64_t *inmem_samplerKernel_samplerKernelseed2_mt_seeds2; /**<  [in] Mapped ROM inmem_samplerKernel_samplerKernelseed2_mt_seeds2, should be of size (624 * sizeof(uint64_t)). */
	const uint64_t *inmem_samplerKernel_samplerKernelseed2_mt_seeds3; /**<  [in] Mapped ROM inmem_samplerKernel_samplerKernelseed2_mt_seeds3, should be of size (624 * sizeof(uint64_t)). */
} sampler_actions_t;
